...
from .views import ManageBill, CreateNewGuest,Dishes, Drinks, HomeFirst ,Home, DrinkDetails, DishDetails, GetAllergen,ManageBillDish,ManageBillDrink,AllBillDish,AllBillDrink,ManageGuest
urlpatterns = [
    ...
    path('guest/<int:pk>/', ManageGuest.as_view(),name='guest_manage')
]